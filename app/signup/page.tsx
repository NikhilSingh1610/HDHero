...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-red-100 to-blue-50 p-4 animate-gradient-x">
      <motion.div 
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            {error && (
              <motion.div 
                className="text-red-500 text-sm bg-red-50 p-3 rounded-lg flex items-start"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              >
